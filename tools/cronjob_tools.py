...
def schedule_cronjob(
    ...
    Args:
        ...
        deliver: Where to send the output. Options:
                 ...
                 - "local": Save to local files only (~/.arachne/cron/output/)
    ...
    origin = None
    origin_platform = os.getenv("ARACHNE_SESSION_PLATFORM")
    origin_chat_id = os.getenv("ARACHNE_SESSION_CHAT_ID")
    if origin_platform and origin_chat_id:
        origin = {
            "platform": origin_platform,
            "chat_id": origin_chat_id,
            "chat_name": os.getenv("ARACHNE_SESSION_CHAT_NAME"),
        }
...
def check_cronjob_requirements() -> bool:
    ...
    """
    return bool(
        os.getenv("ARACHNE_INTERACTIVE")
        or os.getenv("ARACHNE_GATEWAY_SESSION")
        or os.getenv("ARACHNE_EXEC_ASK")
    )
