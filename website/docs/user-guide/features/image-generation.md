...
Arachne Agent can generate images from text prompts using FAL.ai's **FLUX 2 Pro** model with automatic 2x upscaling via the **Clarity Upscaler** for enhanced quality.
...
When you ask Arachne to generate an image:
...
Simply ask Arachne to create an image:
