#!/usr/bin/env python3
"""Google Workspace OAuth2 setup for Arachne Agent.
...
CLIENT_SECRET_PATH = ARACHNE_HOME / "google_client_secret.json"
...
def store_client_secret(path: str):
    """Copy and validate client_secret.json to Arachne home."""
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace OAuth setup for Arachne")
