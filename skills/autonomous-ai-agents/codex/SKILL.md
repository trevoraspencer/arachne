...
metadata:
  arachne:
    ...
    related_skills: [claude-code, arachne]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Arachne terminal. Codex is OpenAI's autonomous coding agent CLI.
