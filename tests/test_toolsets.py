...
class TestToolsetConsistency:
    ...
    def test_arachne_platforms_share_core_tools(self):
        """All arachne-* platform toolsets should have the same tools."""
        platforms = ["arachne-cli", "arachne-telegram", "arachne-discord", "arachne-whatsapp", "arachne-slack"]
